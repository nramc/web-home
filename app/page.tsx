  ...
  return (
    <main className="overflow-hidden">
      ...
      <header className="mx-auto flex max-w-6xl items-center justify-between px-6 py-4 lg:px-8">
        <Link className="font-heading text-lg font-bold tracking-tight" href="/">
      ...
      <section className="mx-auto grid max-w-6xl items-center gap-14 px-6 pt-14 pb-20 lg:grid-cols-[1.12fr_0.88fr] lg:gap-20 lg:px-8 lg:pt-20 lg:pb-24">
        <div>
          ...
          <p className="mt-7 max-w-xl text-lg leading-8 text-muted-foreground sm:text-xl">
            I&apos;m Ram, a senior software engineer creating reliable products,
            APIs, and open-source tools from idea to launch.
          </p>
          <div className="mt-8 flex flex-col gap-3 sm:flex-row">
            ...
            <Button asChild className="h-11 rounded-full px-6" size="lg" variant="outline">
              <a
                ...
                target="_blank"
              >
                More about me <ExternalLink aria-hidden="true" />
              </a>
            </Button>
          </div>
        </div>
        <div className="relative mx-auto w-full max-w-md lg:mx-0 lg:justify-self-end">
          ...
          <div className="relative overflow-hidden rounded-3xl border border-primary/20 bg-slate-950 p-5 text-slate-100 shadow-2xl shadow-primary/10 dark:bg-slate-900">
            <div className="mb-6 flex items-center justify-between border-b border-white/10 pb-4">
              ...
              <span className="font-mono text-[11px] text-slate-400">ram.ts</span>
            </div>
            <div className="font-mono text-sm leading-7">
              ...
              <p className="pl-5">
                focus: <span className="text-emerald-300">&quot;useful software&quot;</span>,
              </p>
              <p className="pl-5">
                craft: <span className="text-emerald-300">&quot;full-stack&quot;</span>,
              </p>
              <p className="pl-5">
                values: [<span className="text-amber-200">&quot;clarity&quot;</span>,{" "}
                <span className="text-amber-200">&quot;curiosity&quot;</span>],
              </p>
              <p>{"}"}</p>
              <p className="mt-5 text-slate-500">
                <span className="text-emerald-300">✓</span> shipping ideas that
                matter
              </p>
            </div>
          </div>
          <div className="absolute -right-3 -bottom-5 rounded-2xl border border-border/70 bg-background/90 px-4 py-3 shadow-xl backdrop-blur">
            ...
            <p className="mt-1 flex items-center gap-2 text-sm font-medium">
              <Code2 className="size-4 text-primary" /> APIs &amp; open source
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mx-auto max-w-6xl px-6 lg:px-8">
          <div className="mb-12 flex flex-col justify-between gap-5 md:flex-row md:items-end">
            ...
            <p className="max-w-sm text-sm leading-6 text-muted-foreground">
              A mix of personal products, experiments, writing, and libraries
              that reflect how I like to solve problems.
            </p>
          </div>
      ...
      >
        ...
        <div className="space-y-6 text-lg leading-8 text-muted-foreground">
          <p>
            I enjoy turning ideas into dependable software: understanding the
            problem, shaping a simple solution, and carrying it through to a
            thoughtful implementation.
          </p>
          <p>
            From web experiences and APIs to Java libraries and creative
            experiments, I care about clarity, maintainability, and building
      ...
      <footer className="border-t border-border/70">
        <div className="mx-auto flex max-w-6xl flex-col gap-2 px-6 py-8 text-sm text-muted-foreground sm:flex-row sm:items-center sm:justify-between lg:px-8">
          <p>
            <span className="font-medium text-foreground">Ram</span> — building
